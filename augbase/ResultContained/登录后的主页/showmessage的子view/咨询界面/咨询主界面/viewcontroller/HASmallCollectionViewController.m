...
#pragma 背景view添加了两个imageview。一个为正，一个为倒置，第二个可能并不需要，可以改为高斯模糊
- (void)viewDidLoad
{
    [super viewDidLoad];
    ...
    // ImageView on top
    _topImage = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, ViewWidth, ViewHeight/2)];
    _reflected = [[UIImageView alloc] initWithFrame:CGRectMake(0, CGRectGetHeight(_topImage.bounds), ViewWidth, ViewHeight/2)];
    ...
    // Label logo
    UILabel *logo = [[UILabel alloc] initWithFrame:CGRectMake(15, 70, 290, 0)];
