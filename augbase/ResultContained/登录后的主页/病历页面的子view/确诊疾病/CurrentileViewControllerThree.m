//
//  CurrentileViewControllerThree.m
//  Yizhen2
//
...
#import "TMCache.h"
@interface CurrentileViewControllerThree ()

@end

@implementation CurrentileViewControllerThree
...
-(void)initnavBar{
    ...
    [self setNewbarTitle:@"病毒基因型" andbackground:IMAGE(@"new128")];
...
-(void)initDataSource{
    ...
    [self.mydatas addObject:@"乙肝病毒基因A型"];
    [self.mydatas addObject:@"乙肝病毒基因B型"];
    [self.mydatas addObject:@"乙肝病毒基因C型"];
    [self.mydatas addObject:@"乙肝病毒基因D型"];
    [self.mydatas addObject:@"乙肝病毒基因E型"];
    [self.mydatas addObject:@"乙肝病毒基因F型"];
    [self.mydatas addObject:@"乙肝病毒基因G型"];
    [self.mydatas addObject:@"丙肝病毒基因1型"];
    [self.mydatas addObject:@"丙肝病毒基因2型"];
    [self.mydatas addObject:@"丙肝病毒基因3型"];
...
-(void)posturl{
    ...
    for (int i=0; i<self.currentArray.count; i++) {
        ...
        if ([str isEqualToString:@"乙肝病毒基因A型"]) {
            [keyarray2 addObject:@"20"];
        }
        else if ([str isEqualToString:@"乙肝病毒基因B型"]){
            [keyarray2 addObject:@"21"];
        }
        else if ([str isEqualToString:@"乙肝病毒基因C型"]){
            [keyarray2 addObject:@"22"];
        }
        else if ([str isEqualToString:@"乙肝病毒基因D型"]){
            [keyarray2 addObject:@"23"];
        }
        else if ([str isEqualToString:@"乙肝病毒基因E型"]){
            [keyarray2 addObject:@"24"];
        }
        else if  ([str isEqualToString:@"乙肝病毒基因F型"]){
            [keyarray2 addObject:@"25"];
        }
        else if  ([str isEqualToString:@"乙肝病毒基因G型"]){
            [keyarray2 addObject:@"26"];
        }
        
        else if  ([str isEqualToString:@"丙肝病毒基因1型"]){
            [keyarray2 addObject:@"27"];
        }
        else if  ([str isEqualToString:@"丙肝病毒基因2型"]){
            [keyarray2 addObject:@"28"];
        }
        else if  ([str isEqualToString:@"丙肝病毒基因3型"]){
            [keyarray2 addObject:@"29"];
        }
...
-(void)setiles:(NSMutableArray *)array{
    ...
    NSString *uurl=[NSString stringWithFormat:@"%@?uid=%@&token=%@&category=%@&did=%@",url,[defaults objectForKey:@"userUID"],[defaults objectForKey:@"userToken"],@"2",mystring];
