...
- (void)viewDidLoad {
    [super viewDidLoad];
    _contactGroupTable.delegate = self;
    _contactGroupTable.dataSource = self;
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    self.title = NSLocalizedString(@"兴趣群", @"");
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell = [tableView dequeueReusableCellWithIdentifier:@"groupdetailcell" forIndexPath:indexPath];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    UITableViewCell *targetCell = [_contactGroupTable cellForRowAtIndexPath:indexPath];
