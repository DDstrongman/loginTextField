...
#define kButtonBottomOffset 10.0f
        ...
        [self.rightBtn setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithRed:58/255.0 green:180/255.0 blue:167/255.0 alpha:1]] forState:UIControlStateNormal];
        [self.leftBtn setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithRed:247/255.0 green:101/255.0 blue:78/255.0 alpha:1]] forState:UIControlStateNormal];
